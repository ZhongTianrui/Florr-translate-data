const translate = {
    ...
    //用户界面-地图名称
    'Centralia': '中心之地',
    'Centralia Fields 1': '后花园 1',
    'Centralia Fields 2': '后花园 2',
    'Centralia Fields 3': '后花园 3',
    'Centralia Fields 4': '后花园 4',
    'Centralia Fields 5': '后花园 5',
    'Centralia Fields 6': '后花园 6',
    'Centralia Fields 7': '后花园 7',
    'Centralia Maze': '后花园迷宫',

    'Centralia Sewers 1': '后花园下水道 1',
    'Centralia Sewers 2': '后花园下水道 2',
    'Centralia Sewers 3': '后花园下水道 3',
    'Centralia Sewers 4': '后花园下水道 4',

    'Centralia Beach': '后花园海滩',
    'East Waters 1': '东部水域 1',
    'East Waters 2': '东部水域 2',
    'East Waters 3': '东部水域 3',
    'East Waters 4': '东部水域 4',
    'East Waters 6': '东部水域 6',
    'Jellyfish Fields': '水母之地',
    'Crab Kingdom': '螃蟹王国',

    'South Desert 1': '南部沙漠 1',
    'South Desert 2': '南部沙漠 2',
    'South Desert 3': '南部沙漠 3',
    'South Desert 4': '南部沙漠 4',
    'South Desert 5': '南部沙漠 5',
    ...
    'Ellne': '爱尔林',
    'Ellne Pass': '爱尔林小径',
    'Ellne Jungle 1':'爱尔林 1区',
    'Ellne Jungle 2':'爱尔林 2区',
    'Ellne Jungle 3':'爱尔林 3区',
    'Ellne Jungle 4':'爱尔林 4区',
    'Ellne Jungle 5':'爱尔林 5区',
    ...
    'Jellyfish': '水母',
    'Makes the most delicious jam': '可制作最美味的 jam。',



    'Ladybug': '瓢虫',
    'Shiny, cute and mostly harmless.': '闪亮，可爱，而且大部分时间无害。',
    ...
    'Queen Fire Ant': '火蚁后',
    'This ant is on fireeeeeeeeeeeeee.': '产火蚁的东西。',
    ...
    'This ant is on fireeeeeeeeeeeeee.': '这只蚂蚁着着着...着火了',


    'Soldier Termite': '兵白蚁',
    'It\'s got wings and it\'s ready to use them.': '翅膀硬了，随时准备搞事情。',
    'These creatures appear to be connected somehow.' : '这些生物似乎通过某种方式连接了起来。',
    ...
    'Worker Termite': '工白蚁',
    'It\'s a bit temperamental, probably from working all the time. These creatures appear to be connected somehow.': '这家伙有些喜怒无常，可能是持续不断的工作导致的。这些生物似乎通过某种方式连接了起来。',
    ...
    //丛林
    'Bush': '灌木',
    'Don\'t misunderestimate me.': '不要小看我。',


    'Leafbug': '叶虫',
    'It\'s not a leaf,but it is a bug.': '这不是叶子，而是虫子。',


    'Mantis': '螳螂',
    'You better pray you don\'t become dinner.': '你最好祈祷不会变成晚餐',
    'Debuff': '削弱',
...
const readline = require('readline').createInterface({
  ...
  readline.question(`String(English):`, name => {
    if (typeof(translate[name]) == 'string') console.log(translate[name]);
    else console.log("String not fund!");
    readline.close();
  });
